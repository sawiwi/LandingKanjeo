    ...
    <>
      ...
      <div className="tw-grid tw-grid-cols-1 xl:tw-grid-cols-3">
        <div className='tw-relative tw-col-span-1 tw-hidden md:tw-block tw-bg-secondary tw-z-0'>
          <div className='xl:tw-absolute xl:tw-top-36 tw-py-10  xl:tw-mt-56 tw-p-5 xl:tw-px-20'>
          ...
          <div className='xl:tw-absolute xl:tw-bottom-0 tw-py-1 tw-p-5 xl:tw-px-32'>
