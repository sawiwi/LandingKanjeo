const ModalRealtor = ({open, onClose, children }) =>{
    return (
      ...
      className={`tw-fixed tw-inset-0 tw-z-50 xl:tw-top-20  sm:tw-relative sm:tw-flex sm:tw-justify-center sm:tw-items-center tw-w-full tw-transition-colors xl:tw-mx-2 ${open ? "tw-visible tw-bg-black/60 tw-h-full sm:tw-bg-transparent tw-rounded-xl sm:tw-rounded-none 2xl:tw-h-[85vh] " : "tw-invisible"}`} 
      onClick={onClose}>
        {/* Modal */}
        <div className={`tw-bg-white tw-rounded-xl tw-shadow-lg tw-p-6 tw-transition-all tw-w-[99%] tw-h-[95%] xl:tw-h-full tw-overflow-hidden md:tw-overflow-y-auto
