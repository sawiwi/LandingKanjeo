const Modal = ({open, onClose, children }) =>{
    return (
      <>
      <div
      className={`tw-fixed tw-inset-0 tw-z-50 sm:tw-relative sm:tw-flex sm:tw-justify-center sm:tw-items-center tw-w-full tw-transition-colors ${open ? "tw-visible tw-bg-black/60 tw-h-full sm:tw-bg-transparent tw-rounded-xl sm:tw-rounded-none xl:tw-h-full " : "tw-invisible"}`} onClick={onClose}>
        {/* Modal */}
