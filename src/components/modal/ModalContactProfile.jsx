const ModalProfile = ({open, onClose, children }) =>{
    return (
      <div
      className={`tw-fixed tw-inset-0 tw-z-50 xl:tw-py-10 2xl:tw-py-6 tw-flex tw-justify-center tw-items-center tw-transition-colors ${open ? "tw-visible tw-bg-black/50 2xl:tw-h-full tw-z-50" : "tw-invisible"}`} 
      ...
      onClick={onClose}>
        {/* Modal */}
        <div className={`tw-bg-white tw-rounded-xl tw-shadow-lg tw-p-6 tw-transition-all tw-w-[95%] tw-h-[95%] xl:tw-w-[50%] xl:tw-h-[80%] tw-overflow-hidden md:tw-overflow-y-auto
