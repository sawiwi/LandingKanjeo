const ModalExternServices = ({open, onClose, children }) =>{
    return (
      <div
        ...
        className={`tw-fixed tw-top-10 xl:tw-top-[15%] xl:tw-left-[35%] tw-z-50 xl:tw-py-10 2xl:tw-py-6 tw-flex tw-justify-center tw-items-center tw-transition-colors ${open ? "tw-visible xl:tw-w-[30%] xl:tw-h-[75%] tw-bg-black/30 tw-z-50 tw-rounded-lg" : "tw-invisible"}`} 
        onClick={onClose}>
        {/* Modal */}
        <div className={`tw-bg-white tw-rounded-xl tw-shadow-lg tw-p-6 xl:tw-p-3 tw-transition-all tw-w-[99%] xl:tw-w-[95%] tw-h-[95%]  xl:tw-h-[98%] tw-overflow-hidden md:tw-overflow-y-auto
