const ModalContact = ({open, onClose, children }) =>{
    return (
      <div
      className={`tw-fixed tw-top-0 tw-z-50 xl:tw-py-10 2xl:tw-py-6 tw-flex tw-justify-center tw-items-center tw-transition-colors ${open ? "tw-visible tw-bg-black/50 2xl:tw-h-full tw-z-50 tw-rounded-lg" : "tw-invisible"}`} 
