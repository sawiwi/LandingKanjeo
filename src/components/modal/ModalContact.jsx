const ModalContact = ({open, onClose, children }) =>{
    return (
      <div
      className={`fixed top-0 z-50 xl:py-10 2xl:py-6 flex justify-center items-center transition-colors ${open ? "visible bg-black/50 2xl:h-full z-50 rounded-lg" : "invisible"}`} 
      ...
      onClick={onClose}>
        {/* Modal */}
        <div className={`bg-white rounded-xl shadow-lg p-6 transition-all w-[95%] h-[95%] xl:h-full overflow-hidden md:overflow-y-auto
