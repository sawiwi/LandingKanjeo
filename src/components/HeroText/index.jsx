...
const HeroText = () =>{
    return(
        <>
        <div className="tw-relative tw-my-6 lg:tw-my-10 2xl:tw-my-10 tw-p-6 xl:tw-pt-2 2xl:tw-pt-7 lg:tw-px-6 2xl:tw-px-10">
            <small className='tw-text-md 2xl:tw-text-lg tw-font-normal 2xl:tw-font-medium '>Unete hoy mismo a nosotros</small>
            <h2 className="tw-text-2xl xl:tw-text-4xl 2xl:tw-text-5xl tw-font-semibold tw-mb-2 tw-text-secondary">Integrate y se parte de la Comunidad</h2>
             {/* <span className='tw-flex tw-items-center tw-text-2xl xl:tw-text-4xl 2xl:tw-text-5xl tw-font-semibold tw-mb-2 tw-text-secondary'></span> */}
