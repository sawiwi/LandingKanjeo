        ...
        <>
            <div className="tw-flex tw-justify-between tw-items-center tw-gap-2 tw-mb-2">
                <div className="tw-grid">
                    ...
                    <input type="text"
                    placeholder="Buscar"
                    className="tw-w-32 md:tw-w-44 2xl:tw-w-[37vw] tw-p-2 tw-mb-2 tw-mt-2 tw-border tw-bg-transparent tw-rounded-md" 
                    value={filtered}
                    onChange={e => setFiltered(e.target.value)}
                    />
                </div>
            </div>
            <div className="tw-flex tw-justify-start tw-items-center tw-gap-2 2xl:tw-w-[37vw]">
                <div className="tw-grid 2xl:tw-w-full">
                    <label className="tw-font-medium">País</label>
                        <input 
                        id="country"
                        type="text"
                        placeholder="Chile"
                        className="tw-w-32 md:tw-w-44 2xl:tw-w-full tw-p-2 tw-mb-2 tw-mt-2 tw-border tw-bg-transparent tw-rounded-md" 
                        // value={""}
                        // onChange={e => setFiltered(e.target.value)}
                        />
                </div>
          ...
          <div>
            <div className="tw-flex tw-justify-between tw-items-center">
                ...
                <select className="tw-bg-transparent tw-cursor-pointer tw-w-20 lg:tw-w-36 tw-h-10 tw-px-2 tw-my-2 tw-border tw-rounded-md"
            ...
            <div className="tw-flex tw-flex-row tw-justify-center tw-gap-3 tw-m-2 ">
                ...
                <button className="tw-p-2 tw-px-3 tw-rounded-full tw-border hover:tw-bg-secondary-light hover:tw-text-white tw-duration-200" onClick={() => table.previousPage()}>
                    <FaArrowLeft />
                </button>
