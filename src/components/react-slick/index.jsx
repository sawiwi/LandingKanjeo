      ...
      {renderContent?.content[0]?.imgs.map((item) => (
        <div key={item.id} className="tw-relative">
          ...
          <div className="tw-absolute tw-z-50 tw-inset-0 tw-text-center tw-flex tw-flex-col tw-w-[90%] md:tw-w-[70%] lg:tw-w-[60%] xl:tw-w-[40%] tw-mx-auto tw-justify-center tw-items-center tw-z-100 ">
            <h1 className="tw-text-primary tw-mt-9 lg:tw-mt-4 tw-opacity-100 tw-font-bold tw-text-3xl md:tw-text-4xl">
              {renderContent.content[0].headings[0].content}
            </h1>
            <p className="tw-text-white tw-opacity-100 tw-font-light tw-text-md md:tw-text-xl tw-mt-2 md:tw-mt-3">
