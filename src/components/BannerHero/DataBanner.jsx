...
const DataBanner = () =>{
    return(
        <>
        <div className="tw-bg-secondary/80 tw-w-full tw-h-[60%] lg:tw-h-[35%] 2xl:tw-h-[25%]">
            <div className="tw-px-2 2xl:tw-px-8 tw-mx-4 xl:tw-mx-80 2xl:tw-mx-72 lg:tw-py-5 2xl:tw-py-10">
                    <ul className="tw-flex tw-justify-between tw-gap-3 xl:tw-mt-14 2xl:tw-mt-20">
                        ...
                        <li className="tw-block tw-text-center">
                            ...
                            <small className="tw-text-md lg:tw-text-base 2xl:tw-text-xl tw-font-medium tw-text-gray-100">una comunidad extensa</small>
                        </li>
                        <li className="tw-block tw-text-center">
