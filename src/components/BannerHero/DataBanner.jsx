...
const DataBanner = () =>{
    return(
        <>
        <div className="bg-secondary/80 w-full h-[60%] lg:h-[35%] 2xl:h-[25%]">
            <div className="px-2 2xl:px-8 mx-4 xl:mx-80 2xl:mx-72 lg:py-5 2xl:py-10">
                    <ul className="flex justify-between gap-3 xl:mt-14 2xl:mt-20">
