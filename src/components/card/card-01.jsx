...
const Card01 = ({ plan }) => {
  ...
  const _renderedPlanItems =
    ...
    itemList?.map((item, idx) => (
      <li
        key={idx}
        className="tw-flex tw-mb-2 tw-items-start tw-justify-start tw-text-secondary-light"
      >
